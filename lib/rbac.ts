...
export const APP_MODULES: ModuleMetadata[] = [
  ...
  {
    key: 'promotions',
    name: 'Promosi & Harga Coret',
    description: 'Manajemen diskon harga coret, flash sale, dan perlindungan margin HPP',
...
export const MODULE_LABELS: Record<AppModule, string> = {
  ...
  promotions: 'Promosi & Harga Coret',
...
export const MODULE_DESCRIPTIONS: Record<AppModule, string> = {
  ...
  promotions: 'Diskon harga coret produk, flash sale, dan perlindungan margin laba HPP',
